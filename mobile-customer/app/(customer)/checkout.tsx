...
export default function CheckoutScreen() {
  ...
  const {
    ...
    setAmbassadorCode, setNotes,
    removeItem, updateQuantity, getTotal, clearCart,
  } = useCartStore()
    ...
    <View style={styles.container}>
      ...
      {items.length === 0 ? (
        <View style={styles.emptyState}>
          ...
          <Text style={styles.emptySubtitle}>Browse our delicious treats and add them here</Text>
...
const styles = StyleSheet.create({
  ...
  pickerBtnValue: { flex: 1, fontSize: 15, color: '#1a1a1a', fontWeight: '600' },
